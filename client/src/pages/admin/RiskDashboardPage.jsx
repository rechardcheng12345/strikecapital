...
function SectionSkeleton() {
    return (<div className="rounded-none border-2 border-gray-200 bg-white p-5 space-y-4">
...
export function RiskDashboardPage() {
    ...
    return (<div>
      ...
      {!isLoading && risk && hasAlerts && (<div className="mb-6 space-y-3">
          {highUtilization && (<div className="rounded-none border-2 border-red-400 bg-red-50 p-4 flex items-start gap-3">
          ...
          {concentratedTickers.map((t) => (<div key={t.ticker} className="rounded-none border-2 border-orange-400 bg-orange-50 p-4 flex items-start gap-3">
      ...
      {isLoading ? (<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="rounded-none border-2 border-[#0D2654]/20 bg-white p-5 lg:col-span-2">
            <div className="flex items-center gap-2 mb-5">
              ...
              <h2 className="text-lg font-bold text-[#0D2654]" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                Capital Utilization
              </h2>
            </div>
                    ...
                    return (<div key={item.ticker}>
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`text-xs font-bold ${isOver ? 'text-red-500' : 'text-[#0D2654]'}`}>

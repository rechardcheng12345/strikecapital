      ...
      <Card>
        ...
        minLength: { value: 2, message: 'Name must be at least 2 characters' },
              ...
              <div>
                ...
                <Input value={user?.role === 'admin' ? 'Administrator' : 'Investor'} disabled className="bg-gray-50 capitalize"/>
              </div>
            </div>
      ...
      <Card>
        ...
        <CardBody>
          <form onSubmit={handleChangePassword} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Button type="submit" loading={changePasswordMutation.isPending} disabled={!currentPassword || !newPassword || !confirmPassword}>
                Change Password
              </Button>
            </div>
          </form>

...
import { LayoutDashboard, TrendingUp, BarChart3, History, Bell, User, Menu, X, LogOut, } from 'lucide-react';
...
export function InvestorLayout() {
    ...
    const sidebarContent = (<>
      ...
      <nav className="flex-1 py-4 space-y-0.5 overflow-y-auto">
        {investorNavItems.map((item) => (<Link key={item.path} to={item.path} className={navLinkClasses(item.path, item.exact)}>
